  ...
  return (
    <nav className='container-bottomNav'>
        <div className='btnHome'>
          <Link to='/'>
            <img src={props.menu==="Home" ? srcBtnHomeOn : srcBtnHomeOff} alt="btn" />
          </Link>
        </div>
        <div className='btnReview'>
          <Link to='/Review'>
            <img src={props.menu==="Review" ? srcBtnReviewOn : srcBtnReviewOff} alt="btn" />
          </Link>
        </div>
        <div className='btnList'>
          <Link to='/'>
            <img src={props.menu==="List" ? srcBtnListOn : srcBtnListOff} alt="btn" />
          </Link>
        </div>
        <div className='btnMyPage'>
          <Link to='/'>
            <img src={props.menu==="MyPage" ? srcBtnMypageOn : srcBtnMypageOff} alt="btn" />
          </Link>
        </div>
    </nav>
  )
