...
export default function AvailableC() {
  ...
  const urlget = `https://babzip.seunga.shop/coupon/available`;
  function getCoupon() {
    api
      .get(urlget)
      ...
      {couponData.length ? (
        <div className="result-availableC">
          {couponData.map((item) => {
            return (
              <div
                className="container-availableC"
                style={{
                  backgroundImage: `url(${srcCouponBack})`,
              ...
              >
                <div className="detail-availableC">
                  ...
                  <div className="date-detail">
                    ...
                    <p className="finalDate-detail">
                      사용기간 {item.finalDate} 까지
                    </p>
                  </div>
                </div>
