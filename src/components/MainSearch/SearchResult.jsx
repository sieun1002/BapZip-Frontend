...
export default function SearchResult(props) {
  ...
  function getStore() {
    const urlget = `https://babzip.seunga.shop/stores/search?name=${props.text}`;
    api
      .get(urlget)
      ...
      {props.text ? (
        ...
        <div className="beforeSearch-MainSearch">
          ...
          <div className="recommendSearch-beforeSearch">
            <button
              className="keyword-recommendSearch"
              onClick={() => props.setTxt(keywords[0])}
            >
              {keywords[0]}
            </button>
            <button
              className="keyword-recommendSearch"
              onClick={() => props.setTxt(keywords[1])}
            >
              {keywords[1]}
            </button>
            <button
              className="keyword-recommendSearch"
              onClick={() => props.setTxt(keywords[2])}
            >
              {keywords[2]}
            </button>
            <button
              className="keyword-recommendSearch"
              onClick={() => props.setTxt(keywords[3])}
            >
              {keywords[3]}
            </button>
            <button
              className="keyword-recommendSearch"
              onClick={() => props.setTxt(keywords[4])}
            >
              {keywords[4]}
            </button>
            <button
              className="keyword-recommendSearch"
              onClick={() => props.setTxt(keywords[5])}
            >
              {keywords[5]}
            </button>
          </div>
