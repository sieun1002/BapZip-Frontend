...
import Taco from "../../images/Silsiganin/Taco.png";
...
import Rank5 from "../../images/Silsiganin/Rank5.png";
...
const Restaurant2 = () => {
  ...
  return (
    <Container>
      <Rankimg src={Rank5} alt="Ranking" />
      <ImageStyleFood src={Taco} alt="Bunsik" />
